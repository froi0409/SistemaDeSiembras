...
-- Schema SOWING_MOON
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `SOWING_MOON` DEFAULT CHARACTER SET utf8 ;
USE `SOWING_MOON` ;
...
CREATE TABLE IF NOT EXISTS `SOWING_MOON`.`CONSIDERACION` (
  ...
  `codigo_fase` VARCHAR(25) NOT NULL,
  `codigo_plantas` VARCHAR(40) NOT NULL,
  `descripcion_accion` VARCHAR(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `SOWING_MOON`.`PLANTA` (
  ...
  `descripcion_planta` VARCHAR(250) NOT NULL,
